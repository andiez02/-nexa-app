...
Future<void> configureDependencies() async {
  ...
  // Feature Providers
  getIt.registerLazySingleton<AppProvider>(() => AppProvider(getIt<IStorageService>()));
  getIt.registerLazySingleton<WalletProvider>(() => WalletProvider(getIt<IStorageService>()));
}
